# This Makefile is for the Maypole::Plugin::Component extension to perl.
#
...
#     NAME => q[Maypole::Plugin::Component]
#     PREREQ_PM => { Maypole=>q[2.0] }
#     VERSION_FROM => q[Component.pm]
...
NAME_SYM = Maypole_Plugin_Component
VERSION = 0.05
...
FULLEXT = Maypole/Plugin/Component
BASEEXT = Component
...
TO_INST_PM = Component.pm

PM_TO_BLIB = Component.pm \
	$(INST_LIB)/Maypole/Plugin/Component.pm
...
DISTNAME = Maypole-Plugin-Component
DISTVNAME = Maypole-Plugin-Component-0.05
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=3pm --perm_rw=$(PERM_RW)\
	  Component.pm $(INST_MAN3DIR)/Maypole::Plugin::Component.$(MAN3EXT) 
...
realclean purge ::  clean realclean_subdirs
	...
	$(RM_RF) $(DISTVNAME)
	$(RM_F)  $(INST_LIB)/Maypole/Plugin/Component.pm $(MAKEFILE_OLD) $(FIRST_MAKEFILE)
...
metafile :
	...
	$(NOECHO) $(ECHO) 'name:         Maypole-Plugin-Component' >> META.yml
	$(NOECHO) $(ECHO) 'version:      0.05' >> META.yml
	$(NOECHO) $(ECHO) 'version_from: Component.pm' >> META.yml
...
pm_to_blib: $(TO_INST_PM)
	$(NOECHO) $(PERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', '\''$(PM_FILTER)'\'')'\
	  Component.pm $(INST_LIB)/Maypole/Plugin/Component.pm 
	$(NOECHO) $(TOUCH) $@
